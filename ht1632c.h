...
extern inline void ht1632c_bright(uint8_t val);

/* onoff: val==0: turn off system oscillator and LED duty cycle generator
 *        val==1: turn on system oscillator */
extern inline void ht1632c_onoff(uint8_t val);

/* val==0: turn off LED duty cycle generator;
 * val==1: turn on LED duty cycle generator */
extern inline void ht1632c_ledonoff(uint8_t val);

/* turn on or off blinking function */
extern inline void ht1632c_blinkonoff(uint8_t val);

/* val == 0: slave mode, 1: master mode */
extern inline void ht1632c_slave(uint8_t val);

/* 0: on chip RC, 1: external clock */
extern inline void ht1632c_clock(uint8_t val);
 ...
 */
extern inline void ht1632c_opts(uint8_t val);
